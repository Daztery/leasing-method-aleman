...
class PrestamoForm(forms.ModelForm):
    ...
    'frecuencia_de_pago', 'tipo_de_pago', 'tipo_tasa_interes', 'periodo_cap', 'tasa_de_interes', 
    'recompra', 'costos_notariales', 'costos_registrales', 'tasacion', 'comision_de_estudio', 
    'comision_de_activacion', 'comision_periodica', 'seguro_riesgo', 'fecha_inicio', 'plazo_de_gracia', 
    'periodo_inicial_pg', 'tasa_descuento_Ks', 'tasa_descuento_WACC', 'modelo', 'vehiculo']
